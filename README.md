...
│
├── agentprecept/     ← CLI（init(6阶段)/sync/audit(15维)/doctor/hooks/gnhf）+ MCP Server（6 tools）
├── scripts/           ← sync-graph(5维)/graph-to-mermaid/basic-audit(15维)/design_gate_check/check-naming
├── docs/
